  ...
  return (
    <section className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 pt-24 text-center">
        ...
        <Link href="/reservations" className="mt-10 rounded-full border border-amber-500/70 bg-amber-700/80 px-10 py-4 text-sm font-medium tracking-[0.25em] text-amber-50 uppercase shadow-[0_0_40px_rgba(180,83,9,0.35)] transition hover:scale-[1.02] hover:bg-amber-600/90">
          Reservation
        </Link>
      </div>
    </section>
